...
public  final class AsyncRecognizeResponse extends
  ...
  private AsyncRecognizeResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            results_.add(input.readMessage(com.google.cloud.speech.v1beta1.SpeechRecognitionResult.parser(), extensionRegistry));
            break;
          }
        }
      }
